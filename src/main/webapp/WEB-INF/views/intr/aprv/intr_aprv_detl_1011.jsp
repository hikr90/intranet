								...
								<div class="post_wrap">
									...
									<div class="post_view">
										...
										<dl>
								        	<dt>&#10003; 지급 일자</dt>
											<dd>
												<input type="text" class="srch_cdt_date srchSdt" id="prepayDt" name="prepayDt" title="지급 일자" value="" readonly="readonly" isRequired="Y" />
											</dd>
											<dt>&#10003; 지급 방법</dt>
											<dd class="sel_2part">
								        ...
								        <dl>
								        	<dt>&#10003; 사유</dt>
											<dd>
												<input type="text" id="prepayRsn" title="사유" name="prepayRsn" isRequired="Y">
											</dd>
								        </dl>
								        <dl>
